...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add Catégory"><i class="fas fa-plus"></i> Ajouter une catégorie</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            ...
            @foreach($categories as $category)
              ...
              @endphp
                <tr>
                    <td>
                        @if($category['imgPathLink'])
                            <img src="{{ asset($category['imgPathLink'])}}" class="img-fluid" style="max-width:80px" alt="{{$category['imgPathLink']}}">
                        @else
